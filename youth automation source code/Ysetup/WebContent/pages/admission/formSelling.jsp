							...
							<div class="art-post">
								<div class="art-post-body">
									...
									<sj:tabbedpanel id="mytabs" animate="true" collapsible="false"
										...
										<sj:tab id="tab1" target="tone" label="Enquiry" />
										<sj:tab id="tab2" target="ttwo" label="Form Issue" />
										<div id="tone">
											<%@include
												file="/pages/admission/formSelling_enquiry_tab.jsp"%>

										</div>
										<div id="ttwo">
											<%@include file="/pages/admission/formSelling_search_tab.jsp"%>
										</div>
									</sj:tabbedpanel>
								</div>
							</div>
